...
import           Lib.URL.Component.Fragment (Fragment)
import qualified Lib.URL.Component.Fragment as Fragment
import           Lib.URL.Component.Host     (Host)
import qualified Lib.URL.Component.Host     as Host
import           Lib.URL.Component.Path     (Path)
import qualified Lib.URL.Component.Path     as Path
import           Lib.URL.Component.Port     (Port)
import qualified Lib.URL.Component.Port     as Port
import           Lib.URL.Component.Query    (Query)
import qualified Lib.URL.Component.Query    as Query
import           Lib.URL.Component.User     (User)
import qualified Lib.URL.Component.User     as User
