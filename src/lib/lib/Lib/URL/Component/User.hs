...
import           Lib.URL.Component.User.Name     (Name)
import qualified Lib.URL.Component.User.Name     as Name
import           Lib.URL.Component.User.Password (Password)
import qualified Lib.URL.Component.User.Password as Password
